...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            style = {'textAlign': 'center', 'padding': 3, 'font-size': 20, 'width': 250}
        )
    ]),
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        x='Vehicle_Type',
        y='Automobile_Sales',
        title = 'Sales Volume of each Vehicle Type'))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
                    ...
                    names='Vehicle_Type',
                    title="Proportion of Advertising Expenditure per Vehicle Type During Recession"
                )
        )

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_rate = data.groupby(['unemployment_rate', 'Vehicle_Type'])['Automobile_Sales'].sum().reset_index()
        fig = px.bar(unemp_rate,
            x='unemployment_rate',
            y='Automobile_Sales',
            color = 'Vehicle_Type',
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart4 = dcc.Graph(figure= px.pie(exp_data,
            values='Advertising_Expenditure',
            names='Vehicle_Type',
            title="Proportion of Advertising Expenditure per Vehicle Type"
        ))
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        ...
        return html.H1('year: ' + str(input_year) + "selected: " + selected_statistics)
